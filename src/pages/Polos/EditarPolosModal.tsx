...
interface EditarPolosModalProps {
  open: boolean;
  onClose: () => void;
  polos: PolosInterface | null;
}

const EditarPolosModal: React.FC<EditarPolosModalProps> = ({ open, onClose, polos }) => {
    ...
    const handleSave = async () => {
        ...
        try {
          await axios.put(`${urlServidor}/polos/${polos?.id}`, polosAtualizado, { headers });
  ...
  export default EditarPolosModal;
