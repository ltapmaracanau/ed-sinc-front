...
const aplicarMascaraTelefone = (valor: string) => {
  if (!valor) return ''; // Verificação para garantir que valor não seja null ou undefined
  return valor
...
const EditarUsuarioModal: React.FC<EditarUsuarioModalProps> = ({ open, onClose, usuario }) => {
    ...
    useEffect(() => {
      if (usuario) {
        ...
        setSenhaEConfirmarSenha({ senha: '', confirmarSenha: '' }); // Limpar os campos de senha ao carregar um usuário
